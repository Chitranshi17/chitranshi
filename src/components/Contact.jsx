      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:chitranshigourana17@gmail.com" target="_blank" className="blue-text-gradient">chitranshigourana17@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=917415061124&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 7415061124
            </a>
          </article>
        </div>
