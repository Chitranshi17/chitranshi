...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: ["Front End Developer", 'Software Developer ',] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Chitranshi Gourana</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/Chitranshi17" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/chitranshi-gourana-2a4904245/" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/art_the_piction/" target="_blank">
          <AiOutlineInstagram />
        </a>
