...
import { github, javascript } from "../assets";
import { demo } from "../assets";
import { SectionWrapper } from "../hoc";
import {HTMLCSSProject, JavaScriptProject, ReactJSProject, list} from "../constants"
      ...
      >
        <div className='Box1 relative w-full h-[180px]'>
          <img
            src={image}
            alt='project_image'
            className='image w-full h-full object-content rounded-2xl'
          />
